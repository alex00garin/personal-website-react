        ...
        <div className='md:w-1/2 block'>
          ...
          <ol className='block mt-10 md:mt-12 border-l border-neutral-200 dark:border-neutral-700 justify-start text-left ml-5'>
            ...
            <li className=' ml-8 text-left slide-element'>
              ...
              <h3 className='flex mb-1 ml-8 text-md font-semibold text-black dark:text-white'>Java/Spring/Spring Boot/REST</h3>
              <time className='flex mb-2 ml-7 text-sm font-normal leading-none text-neutral-700 dark:text-neutral-500'>September 2023</time>
              <p className='text-base font-normal text-neutral-500 dark:text-neutral-400'>Actively learning and working with Java and Spring framework.</p>
            </li>
          </ol>
        </div>
